...
// NOTA: Se elimina la interfaz RouteContext para evitar el error de tipado con el compilador de Next.js.
// El tipado se define inline en cada función de ruta: { params }: { params: { id: string } }
...
/** GET single feeding */
// CORREGIDO: Usar tipado inline para Next.js Route Handlers
