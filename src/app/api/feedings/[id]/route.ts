...
export async function GET(req: NextRequest) {
    ...
    try {
        ...
        return NextResponse.json({ success: false, msg: e?.message || 'Error interno al obtener alimentaciones' }, { status: 500 });
    } finally {
        client.release();
    }
}
...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const errorMessage = e?.message || 'Error interno al crear alimentación';
        return NextResponse.json({ success: false, msg: errorMessage }, { status: 500 });
    } finally {
        client.release();
    }
}
