...
// 1. AÑADIDO: Interfaz para el contexto de la ruta dinámica
interface RouteContext {
    params: {
        id: string; // El segmento [id] se recibe como un string
    };
}
...
/* computeMes queda para lecturas/consistencia internas si la necesitas,
   pero **NO** se escribe en la BD porque la columna es generada. */
...
/** GET single feeding */
// 2. CORREGIDO: Usar { params } en la firma de la función
...
// 3. CORREGIDO: Usar { params } en la firma de la función
export async function PUT(req: NextRequest, { params }: RouteContext) {
    ...
    // NOTA: no escribir `mes` (columna generada por la BD)
...
/** PATCH (parcial) */
// 4. CORREGIDO: Usar { params } en la firma de la función
export async function PATCH(req: NextRequest, { params }: RouteContext) {
    ...
    try {
        ...
        // Recalcular campos dependientes si vienen (NO escribimos mes)
...
/** DELETE (soft) */
// 5. CORREGIDO: Usar { params } en la firma de la función
